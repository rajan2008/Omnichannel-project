...
// Step 3: Login User — check credentials and return JWT token
export const loginUser = async (req, res) => {
  try {
    ...
    if (!user.isVerified) return res.status(403).json({ message: "Please verify your account using OTP first" });
